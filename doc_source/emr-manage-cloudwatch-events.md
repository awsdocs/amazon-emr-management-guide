...
1. Choose event states and other details according to your requirements for event handling\. To create a rule by modifying the JSON according to the guidelines in [Events and Event Patterns](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatchEventsandEventPatterns.html), choose **Show advanced options**, **edit\.**
