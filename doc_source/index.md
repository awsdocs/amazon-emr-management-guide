...
+ [Amazon EMR Studio](emr-studio.md)
   ...
   + [Set up an Amazon EMR Studio](emr-studio-set-up.md)
      + [Choose an authentication mode for Amazon EMR Studio](emr-studio-authentication.md)
      + [Configure EMR Studio security](emr-studio-security.md)
         ...
         + [Configure EMR Studio user permissions](emr-studio-user-permissions.md)
            + [AWS Identity and Access Management permissions for EMR Studio users](emr-studio-iam-permissions-table.md)
      ...
      + [Permissions required to create and manage an EMR Studio](emr-studio-admin-permissions.md)
      + [Create an EMR Studio](emr-studio-create-studio.md)
      + [Assign and manage EMR Studio users](emr-studio-manage-users.md)
...
+ [Plan and configure clusters](emr-plan.md)
   ...
   + [Configure cluster hardware and networking](emr-plan-instances.md)
      ...
      + [Configure Amazon EC2 instances](emr-plan-ec2-instances.md)
